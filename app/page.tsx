      ...
      <section className="bg-gray-950 text-white py-20 border-b border-gray-800 px-4">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[ 
              { title: "Stabilna osnova", desc: "Koristimo proverene tehnologije spremne za rast i skaliranje.", icon: "🧱" },
              { title: "Jasan dizajn", desc: "Jednostavno, lepo i intuitivno korisničko iskustvo.", icon: "🎨" },
              { title: "AI integracije", desc: "Uvodimo automatizaciju i inteligentne procese kad to ima smisla.", icon: "🤖" },
              { title: "Partnerski odnos", desc: "Radimo transparentno i dugoročno, kao vaš digitalni partner.", icon: "🤝" }
            ].map((c) => (
              <div
                key={c.title}
